...
//    }
    ...
    @Bean
    public CreateHabitUseCase createHabitUseCase(HabitRepositoryPort habitRepositoryPort, GamificationPort port) {
        return new HabitService(habitRepositoryPort, port);
    }

    @Bean
    public RetrieveHabitsUseCase retrieveHabitsUseCase(HabitRepositoryPort habitRepositoryPort, GamificationPort port) {
        return new HabitService(habitRepositoryPort, port);
    }
}
